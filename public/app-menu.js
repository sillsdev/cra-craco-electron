      ...
      submenu: [
        {
          ...
          click: () => {
            shell.openPath(
              path.join(execFolder(), 'help/cra-craco-electron.chm')
            );
          },
        },
        {
          ...
          click: () => {
            shell.openExternal(
              'https://community.scripture.software.sil.org/c/cra-craco-electron'
            );
          },
        },
        {
          label: 'Web Site',
          click: () => {
            shell.openExternal('https://software.sil.org/cra-craco-electron');
          },
        },
      ],
    },
